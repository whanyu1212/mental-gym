...
|----------------------|-------------------|-----------------------------------------------------------------------------|--------------------------------------|
| Comparison-based     | Bubble Sort       | Simple comparison-based sorting                                             | [Bubble Sort](./src/dsa_from_scratch/python/sorting/bubble_sort.py) |
| Comparison-based     | Insertion Sort    | Builds the final sorted array one item at a time                            | [Insertion Sort](./src/dsa_from_scratch/python/sorting/insertion_sort.py) |
| Comparison-based     | Selection Sort    | Selects the smallest element from an unsorted list in each iteration and places that element at the beginning | [Selection Sort](./src/dsa_from_scratch/python/sorting/selection_sort.py) |
| Comparison-based     | Merge Sort        | Divides the array into halves, sorts them and merges them back together      | [Merge Sort](./src/dsa_from_scratch/python/sorting/merge_sort.py) |
| Comparison-based     | Quick Sort        | Divides the array into partitions and sorts them recursively                 | [Quick Sort](./src/dsa_from_scratch/python/sorting/quick_sort.py) |
| Comparison-based     | Random Quick Sort | Uses a random pivot to divide the array into partitions and sorts them recursively | [Random Quick Sort](./src/dsa_from_scratch/python/sorting/random_quick_sort.py) |
| Non-comparison-based | Bucket Sort       | Distributes elements into buckets and sorts each bucket individually         | [Bucket Sort](./src/dsa_from_scratch/python/sorting/bucket_sort.py) |
| Non-comparison-based | Counting Sort     | Counts the number of objects having distinct key values and uses arithmetic to determine the positions of each key | [Counting Sort](./src/dsa_from_scratch/python/sorting/counting_sort.py) |
| Non-comparison-based | Radix Sort        | Sorts numbers by processing individual digits                               | [Radix Sort](./src/dsa_from_scratch/python/sorting/radix_sort.py) |
...
<details>
  ...
  - [Common Operations for Array](./src/dsa_from_scratch/python/arrays/common_operations.py)
...
<details>
  ...
  - [Singly Linked List](./src/dsa_from_scratch/python/list_adt/singly_linked_list.py)
  - [Doubly Linked List](./src/dsa_from_scratch/python/list_adt/doubly_linked_list.py)
...
<details>
  ...
  - [Stack using Linked List](./src/dsa_from_scratch/python/list_adt/stack_linked_list.py)
  - [Stack using Array](./src/dsa_from_scratch/python/list_adt/stack_array.py)
  - [Queue using Linked List](./src/dsa_from_scratch/python/list_adt/queue_linked_list.py)
  - [Queue using Array](./src/dsa_from_scratch/python/list_adt/queue_array.py)
  - [Deque using Linked List](./src/dsa_from_scratch/python/list_adt/deque_linked_list.py)
  - [Deque using Array](./src/dsa_from_scratch/python/list_adt/deque_array.py)
...
<details>
  ...
  - [Basic heap properties](./src/dsa_from_scratch/python/binary_heap/heap_properties.py)
  - [Min Heap implementation](./src/dsa_from_scratch/python/binary_heap/min_heap_implementation.py)
  - [Max Heap implementation](./src/dsa_from_scratch/python/binary_heap/max_heap_implementation.py)
...
<details>
  ...
  - [Direct Addressing Table](./src/dsa_from_scratch/python/hash_map/direct_addressing_table.py) (simplified hash table)
  - [Common Operations](./src/dsa_from_scratch/python/hash_map/common_operations.py)
  - [Creating HashMap using Array](./src/dsa_from_scratch/python/hash_map/array_hash_map.py)
  - [Open Addressing](./src/dsa_from_scratch/python/hash_map/open_addressing.py)
  - [Separate Chaining](./src/dsa_from_scratch/python/hash_map/separate_chaining.py)
...
<details>
  ...
  - [Binary Tree](./src/dsa_from_scratch/python/tree/binary_tree.py)
  - [Array Representation of Tree](./src/dsa_from_scratch/python/tree/array_representation_of_tree.py)
  - [Binary Search Tree](./src/dsa_from_scratch/python/tree/binary_search_tree.py)
  - [AVL](./src/dsa_from_scratch/python/tree/avl.py)
...
<details>
  ...
  - [Adjacency Matrix](./src/dsa_from_scratch/python/graph/adjacency_matrix.py)
  - [Adjacency List](./src/dsa_from_scratch/python/graph/adjacency_list.py)
  - [Graph Traversal DFS](./src/dsa_from_scratch/python/graph/graph_traversal_dfs.py)
  - [Graph Traversal BFS](./src/dsa_from_scratch/python/graph/graph_traversal_bfs.py)
  - [Application: Detect Cycle](./src/dsa_from_scratch/python/graph/cycle_detection.py)
  - [Application: Topological Sort](./src/dsa_from_scratch/python/graph/toposort.py)
  - [Application: Check Bipartite](./src/dsa_from_scratch/python/graph/check_bipartite.py)
  - [Single-Source Shortest Path: Bellman Ford](./src/dsa_from_scratch/python/graph/bellman_ford.py)
  - [Single-Source Shortest Path: Dijkstra](./src/dsa_from_scratch/python/graph/dijkstra.py)
  - [Single-Source Shortest Path: BFS on unweighted graph](./src/dsa_from_scratch/python/graph/bfs_sssp.py)
  - [Single-Source Shortest Path: Modified Dijkstra](./src/dsa_from_scratch/python/graph/modified_dijkstra.py)
  - [Single-Source Shortest Path: DFS on weighted trees](./src/dsa_from_scratch/python/graph/dfs_weighted_tree.py)
  - [Single-Source Shortest Path: DP on DAG](./src/dsa_from_scratch/python/graph/dp_dag.py)
...
| 219 | Close Duplicates | Check if a vector contains<br>duplicates within a given range | ![Easy](https://img.shields.io/badge/Easy-5CB85C?style=flat-square) | Sliding Window | [![Julia](https://img.shields.io/badge/Julia-9558B2?style=flat-square&logo=julia&logoColor=white)](/src/leetcode/julia/arrays_hashing/CloseDuplicates.jl) |
...
| # | Question | Description | Difficulty | Type | Solution |
|---|----------|-------------|------------|------|----------|
| 20 | Valid Parenthesis | Determine if the input string has valid parentheses | ![Easy](https://img.shields.io/badge/Easy-5CB85C?style=flat-square) | Stack | [![Julia](https://img.shields.io/badge/Julia-9558B2?style=flat-square&logo=julia&logoColor=white)](/src/leetcode/julia/stack/ValidParenthesis.jl) |
| 155 | Min Stack | Build a stack that supports push, pop, top, and retrieve the minimum in O(1) time | ![Easy](https://img.shields.io/badge/Easy-5CB85C?style=flat-square) | Stack | [![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)](/src/leetcode/python/stack/min_stack.py) |
| 150 | Evaluate RPN | Evaluate Reverse Polish Notation expression | ![Medium](https://img.shields.io/badge/Medium-FFA500?style=flat-square) | Stack | [![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)](/src/leetcode/python/stack/eval_rpn.py) |
...
| 239 | Sliding Window Maximum | Find the maximum value in each sliding window of a fixed size k | ![Hard](https://img.shields.io/badge/Hard-DC3545?style=flat-square) | Sliding Window | [![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)](/src/leetcode/python/stack/max_sliding_window.py) |
