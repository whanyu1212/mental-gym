...
This module shows how different approaches use memory,
with concrete examples of common patterns.
"""
...
def string_concat_bad(chars: list[str]) -> str:
    ...
    "ab" + "c" creates new string "abc", doesn't modify "ab".
    """
    result = ""
    for char in chars:
...
def main():
    ...
    print("-" * 40)
    tree = create_balanced_tree(10)  # Depth 10 = 1023 nodes
