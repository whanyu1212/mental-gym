...
This module demonstrates the classic time-space tradeoff using dictionaries,
with visual demonstrations and benchmarks.
"""
...
def visualize_two_sum_tradeoff() -> None:
    ...
    for size in test_sizes:
        ...
        print("{:<10} {:<15.6f} {:<15.6f} {:<20}".format(
            size,
            time_n2,
            time_n,
            f"{dict_space / 1024:.1f} KB"
        ))
...
def visualize_frequency_tradeoff() -> None:
    ...
    for name, nums in test_cases:
        ...
        print("{:<20} {:<15.6f} {:<15.6f} {:<15.1f}x".format(
            name, time1, time2, speedup
        ))
...
def visualize_precomputation_tradeoff() -> None:
    ...
    queries = [(random.randint(0, 9000), random.randint(0, 9999)) 
    ...
    print(f"Tradeoff: 2x space for {time_no_precomp / time_with_precomp:.0f}x faster queries")
...
def visualize_dictionary_memory() -> None:
    ...
    print("\n{:<15} {:<20} {:<20}".format(
        "Size", "Empty Dict", "Int Key-Value Pairs"
    ))
    print("-" * 55)
