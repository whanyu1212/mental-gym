...
This module demonstrates common scenarios where you can trade
space for time (or vice versa) in algorithm design.
"""
...
def main():
    ...
    print(f"   Tradeoff:          O(n) extra space for ~{time_brute/time_hash:.0f}x speed")
    ...
    print(f"   Iterative:         Best! O(n) time, O(1) space")
    ...
    print(f"   Tradeoff:          Space vs preserving input")
