...
class DirectAddressingTable:
    def __init__(self, size: int):
        """
        Initialize a direct addressing table with a given size. In
        direct addressing table, we are using the index as the key and
    ...
    def insert(self, key: int) -> None:
        """
        Insert a key into the direct addressing table. Turn the value to
        True to indicate the presence of the key.
