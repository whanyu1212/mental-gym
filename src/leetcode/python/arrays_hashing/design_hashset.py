class MyHashSet:
    ...
    def __init__(self):
        ...
        # Trade-off: Larger key_space uses more memory but reduces collisions (faster access).
        ...
        # Each bucket will store a LIST of keys that hash to the same index (Separate Chaining).
        self.hash_table = [[] for _ in range(self.key_space)]

    def hash_function(self, key: int) -> int:
        # Simple modulo hash function maps any integer key to a valid index [0, key_space-1].
